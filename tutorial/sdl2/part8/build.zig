...
pub fn build(b: *std.Build) void {
    ...
    const lib_names = [_][]const u8{"sdl2", "stb", "clib"};
    ...
    var assets = [_][]const u8{"mushroom.png", "default.map", "grass.png", "DejaVuSans.ttf"};
    blib.copyAssets(b, assets[0..]);

    // Copy SDL2 dlls to bin folder
    blib.copydll_sdl2(b);
    blib.copydll_sdl2_ttf(b);
